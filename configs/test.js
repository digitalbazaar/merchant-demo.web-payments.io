/*
 * merchant-demo.web-payments.io test configuration.
 *
...
config.loggers.app.filename = _logdir + '/merchant-demo.web-payments.io-test-app.log';
config.loggers.access.filename = _logdir + '/merchant-demo.web-payments.io-test-access.log';
config.loggers.error.filename = _logdir + '/merchant-demo.web-payments.io-test-error.log';
...
config.server.host = 'merchant-demo.web-payments.dev:54443';
...
protractor.suites['merchant-demo.web-payments.io'] = path.join(
