...
bedrock.events.on('bedrock-express.configure.routes', function(app) {
  ...
  app.options('/movies/dr-strangelove', cors(corsOptions));
  app.get('/movies/dr-strangelove', cors(corsOptions),
  ...
  app.options('/movies/dr-strangelove/requests', cors(corsOptions));
  app.get('/movies/dr-strangelove/requests', cors(corsOptions),
    function(req, res, next) {
  ...
  app.options('/movies/dr-strangelove/payments', cors(corsOptions));
  app.post('/movies/dr-strangelove/payments', cors(corsOptions),
    function(req, res, next) {
      res.status(302);
